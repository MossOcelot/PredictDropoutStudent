...
recommend_db = {'alert':[
    ...
    ("เจ๋งแจ๋วสุดจ๊าบ", 0.6), ("ทำได้ดีมากๆ", 0.6), ("มีความรับผดชอบด", 0.5), ("เกงไมซำใครเลย", 0.6), 
    ("อยางมออาชพ", 0.5)
], 'dislike':[
    ('หามนอนดกนะ', 0.5), ('อานหนงสอเยอะ', 0.9), ('อยาเทยวเยอะเกน', 0.5), ('อยาเลนแตเกม', 0.6) , 
    ('หมนทบทวนบทเรยนนะ', 0.8), ('เลนโซเชยลแตพอด', 0.6), ('ควรมสมาธในการทำงาน', 0.7) , 
    ('ควรใชเวลาวางใหเปนประโยชน', 0.8), ('ควรเรยนรทกษะใหมๆ', 0.6), ('อยานอนหลบนานเกนไป', 0.5)
]}
